<!--
  Use this as the README.md in a repo named exactly your GitHub username
  (e.g. github.com/ankitmallya/ankitmallya) so it shows on your profile.
  Replace "ankitmallya" in the image URLs below if your GitHub username is different.
-->
...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=DM+Sans&weight=500&size=22&duration=4000&pause=1500&color=36BCF7&center=true&vCenter=true&width=500&lines=Building+products+that+ship;Tech+%E2%86%92+Product+Manager;Problem+first%2C+then+solution)](https://git.io/typing-svg)
...
| :--- | :--- | :--- |
| Systems thinking, APIs, data (SQL/Python), feasibility and tradeoffs | PRDs, roadmapping, prioritization (RICE/impact–effort), metrics & OKRs | Specs, stakeholder alignment, cross-functional execution |
...
- **Portfolio:** [ankitmallya.github.io](https://ankitmallya.github.io)

---

<div align="center">

*"From code to roadmap — building products that ship."*
